  ...
  const courses = [
    {
      ...
      features: ["HTML, CSS & Tailwind CSS", "Modern JavaScript (ES6+)", "React.js Frontend Framework", "Backend Integration & Deployment"],
      rating: 4.9,
      students: "150+",
    ...
    },
    {
      ...
      illustration: (
        <svg viewBox="0 0 200 120" className="w-full h-36 mx-auto" fill="none" xmlns="http://www.w3.org/2000/svg">
          <rect width="200" height="120" rx="12" fill="#1e293b" opacity="0.4" />
          <rect x="30" y="70" width="12" height="30" rx="2" fill="#3b82f6" />
          <rect x="50" y="50" width="12" height="50" rx="2" fill="#10b981" />
          <rect x="70" y="40" width="12" height="60" rx="2" fill="#eab308" />
          <rect x="90" y="60" width="12" height="40" rx="2" fill="#a855f7" />
          <path d="M 36 65 L 56 45 L 76 35 L 96 55 L 116 25 L 136 45 L 156 15" stroke="#f43f5e" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
          <circle cx="36" cy="65" r="3.5" fill="#f43f5e" />
          <circle cx="56" cy="45" r="3.5" fill="#f43f5e" />
          <circle cx="76" cy="35" r="3.5" fill="#f43f5e" />
          <circle cx="96" cy="55" r="3.5" fill="#f43f5e" />
          <circle cx="116" cy="25" r="3.5" fill="#f43f5e" />
          <circle cx="136" cy="45" r="3.5" fill="#f43f5e" />
          <circle cx="156" cy="15" r="3.5" fill="#f43f5e" />
          <line x1="25" y1="100" x2="175" y2="100" stroke="#475569" strokeWidth="1.5" />
          <line x1="25" y1="20" x2="25" y2="100" stroke="#475569" strokeWidth="1.5" />
        </svg>
      ),
      features: ["Data Analysis with Pandas", "Data Visualization (Seaborn)", "Statistical Modeling & SQL", "Predictive Analytics & Capstones"],
      rating: 4.8,
      students: "80+",
    ...
    },
    {
      ...
      features: ["Supervised & Unsupervised Learning", "Neural Networks & Deep Learning", "Model Deployment & APIs", "TensorFlow & PyTorch Projects"],
      rating: 4.9,
      students: "70+",
      coursetype: "AI & ML"
    },
